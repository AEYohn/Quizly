        ...
        <div className="mx-4 p-4 rounded-2xl bg-gradient-to-br from-violet-500/10 via-violet-600/5 to-fuchsia-500/5 border border-violet-500/20 ring-1 ring-violet-500/10">
            <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-xs text-gray-500">
                    #{entry.rank} of {totalPlayers}
                </span>
            </div>
            <div className="flex items-center gap-4">
                <div className="text-center">
                    <div className="text-3xl font-black text-violet-300 tabular-nums">
                        #{entry.rank}
                    </div>
                </div>
...
export default function CompetePage() {
    ...
    return (
        <div className="min-h-screen bg-gray-950 flex flex-col max-w-lg mx-auto">
            {/* Header */}
            <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-800/40 shrink-0">
                <Link
                    href="/learn"
                    className="p-2 -ml-1 rounded-xl hover:bg-gray-900 text-gray-500 transition-colors"
                >
            ...
            {!isLoading && entries.length === 0 && (
                <div className="flex-1 flex items-center justify-center px-6">
                    <div className="text-center space-y-4">
                        ...
                        <Link
                            href="/feed"
                            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-2xl bg-violet-600 text-white text-sm font-semibold hover:bg-violet-500 transition-all active:scale-[0.98]"
                        >
            ...
            {!isLoading && (
                <div className="fixed bottom-0 left-0 right-0 max-w-lg mx-auto">
                    <div className="bg-gradient-to-t from-gray-950 via-gray-950/95 to-transparent pt-8 pb-5 px-4">
                        <Link
                            href="/feed"
                            className="flex items-center justify-center gap-2 w-full py-3.5 rounded-2xl bg-violet-600 text-white text-sm font-semibold hover:bg-violet-500 transition-all active:scale-[0.98]"
                        >
                            <Zap className="w-4 h-4" />
                            Earn More XP
